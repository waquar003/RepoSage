...
// @ts-nocheck 
/*
 * This file exports the `Utterance` model and its related types.
 *
...
export type GetUtteranceAggregateType<T extends UtteranceAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateUtterance[P]>
    : Prisma.GetScalarType<T[P], AggregateUtterance[P]>
}
...
type GetUtteranceGroupByPayload<T extends UtteranceGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<UtteranceGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof UtteranceGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], UtteranceGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], UtteranceGroupByOutputType[P]>
      }
    >
  >
...
export type UtteranceCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface UtteranceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends UtteranceCountArgs>(
    args?: Prisma.Subset<T, UtteranceCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], UtteranceCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, UtteranceGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUtteranceGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
